...
public class Game {
   ...
   private static JButton lightButton;
   ...
   private Village village = new Village(80 - DIFFICULTY * 20);
   ...
   private static class MenuDisplay extends Display {
      ...
      private void addContent() {
         ...
         lightButton.setToolTipText("Changes background and text colors. (Buggy)");
         lightButton.setFont(BUTTONFONT);
